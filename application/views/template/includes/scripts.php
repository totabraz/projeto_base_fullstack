...
<!-- Bootstrap WYSIHTML5 -->
<script src="<?php echo base_url('dist/vendors-external/AdminLTE/plugins/bootstrap-wysihtml5/bootstrap3-wysihtml5.all.min.js');?>"></script>
<!-- Slimscroll -->
...
<script src="<?php echo base_url('dist/vendors-external/AdminLTE/js/pages/dashboard.js');?>"></script>
