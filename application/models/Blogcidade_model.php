...
class Blogcidade_model extends CI_Model
{
    var $table = 'blog_cidades';
    ...
    public function getBlogCidadeById($id = 0)
    {
        return $this->getBlogCidade(NULL, NULL, $id);
    }
    private function getBlogCidade($title = NULL, $body = NULL, $id = 0)
    {
        $return = NULL;
        if (isset($title)) {
            safeInput($title);
